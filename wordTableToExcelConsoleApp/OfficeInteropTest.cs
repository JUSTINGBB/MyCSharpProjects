...
{
    class OfficeInteropTest
    {
        //使用Office.Interop创建指定word
        public static void CreateDocx()
        {
            ...
            string headerfile = @"C:\Users\Administrator\Pictures\图标\全图.png";
            ...
            //图片文件的路径
            string filename = "C:\\Users\\Administrator\\Pictures\\图标\\全图.png";
            //要向Word文档中插入图片的位置
            ...
            //向新添加的行的单元格中添加图片
            string FileName = "C:\\Users\\Administrator\\Pictures\\图标\\全图.png";//图片所在路径
